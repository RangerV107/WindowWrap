...
namespace OpenControls.Wpf.DockManager
{
    internal abstract class DockPane : SelectablePane
    {
        ...
        protected void DisplayGeneralMenu()
        {
            ...
            menuItem.Command = new OpenControls.Wpf.Utilities.Command(delegate { FireFloat(false); }, delegate { return true; });
            ...
            if (viewCount > 2)
            {
                ...
                menuItem.IsChecked = false;
                menuItem.Command = new OpenControls.Wpf.Utilities.Command(delegate { UngroupCurrent?.Invoke(this, null); }, delegate { return true; });
                contextMenu.Items.Add(menuItem);
            }
            ...
            if (viewCount > 1)
            {
                ...
                menuItem.IsChecked = false;
                menuItem.Command = new OpenControls.Wpf.Utilities.Command(delegate { Ungroup?.Invoke(this, null); }, delegate { return true; });
                contextMenu.Items.Add(menuItem);
            }
